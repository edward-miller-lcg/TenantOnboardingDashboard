...
variable "tenant_service_url"           { type = string }
variable "data_acquisition_service_url" { type = string }
variable "report_service_url"           { type = string }
variable "normalization_service_url"    { type = string }
